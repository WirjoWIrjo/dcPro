    ...
    public function run(): void
    {
        ...
        if (DB::table('dc_highlights')->count() === 0) {
            DB::table('dc_highlights')->insert([
                ['metric_name' => 'Uptime Reliability', 'metric_value' => '99.999%', 'icon' => 'bi-shield-check', 'is_demo' => false, 'created_at' => now(), 'updated_at' => now()],
                ['metric_name' => 'Total Power Capacity', 'metric_value' => '20 MW', 'icon' => 'bi-lightning-charge', 'is_demo' => false, 'created_at' => now(), 'updated_at' => now()],
                ['metric_name' => 'Total IT Space', 'metric_value' => '5,000 sqm', 'icon' => 'bi-building', 'is_demo' => false, 'created_at' => now(), 'updated_at' => now()],
                ['metric_name' => 'Global Compliance', 'metric_value' => '12+ Certs', 'icon' => 'bi-patch-check', 'is_demo' => false, 'created_at' => now(), 'updated_at' => now()],
            ]);
        }
        ...
        if (DB::table('energy_metrics')->count() === 0) {
            DB::table('energy_metrics')->insert([
                ['period' => 'Q1 2026', 'pue_value' => 1.45, 'total_consumption' => 1250000, 'is_demo' => false, 'created_at' => now(), 'updated_at' => now()],
                ['period' => 'Q2 2026', 'pue_value' => 1.38, 'total_consumption' => 1180000, 'is_demo' => false, 'created_at' => now(), 'updated_at' => now()],
            ]);
        }
    }
}
